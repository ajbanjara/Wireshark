 ...
 *
 * Copyright 2021, Triton Circonflexe <triton[at]kumal.info>
 *
...
static int hf_tcustom_register_unregister = -1;
static int hf_tcustom_register_server_name = -1;
static int hf_tcustom_register_port = -1;
...
static int
dissect_tcustom_register(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data)
{
    thrift_option_data_t *thrift_opt = (thrift_option_data_t *)data;
    int offset = 0;
    proto_item *tcustom_pi = proto_tree_add_item(tree, proto_tcustom, tvb, offset, -1, ENC_NA);;
